...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BlackJackResultNotValid.class)
    public ResponseEntity<?> blackJackResultNotValidHandler(BlackJackResultNotValid exception, WebRequest webRequest) {
